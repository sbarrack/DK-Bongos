...
// address for GPIO mode register of given pin
...
void loop() {
	...
	// TODO input buffer for mod buttons?;
	// L, R = apply mod to 2nd, 3rd note pressed only? fixed harmony, toggle major/minor/interval?
	...
	delay(10); // more error the shorter the time between polls, less time to buffer inputs too
}
